      ...
      <div className="relative flex flex-wrap items-center gap-2 px-3 py-2 sm:px-4">
        <div className="flex min-w-0 shrink-0 items-center gap-1 sm:gap-2">
          <button
            type="button"
            onClick={onRefresh}
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded border border-coffee bg-deepdark text-cream focus:outline-none focus:ring-1 focus:ring-gold disabled:cursor-not-allowed disabled:opacity-50 sm:h-auto sm:w-auto sm:p-2"
        ...
        {showLastNext && (
          <span className="hidden truncate text-2xs text-taupe sm:inline sm:whitespace-nowrap md:inline">
