...
class MatchPredictRequest(BaseModel):
    team_a: str
    team_b: str
    series_format: str = Field(default="BO1")
...
def predict_match_v2(request: MatchPredictRequest) -> MatchPredictResponse:
    ...
    try:
        ...
        team_a = resolver.resolve_team(request.team_a, "api")
        team_b = resolver.resolve_team(request.team_b, "api")
...
def trigger_ingest(data_dir: str = "/data/matches") -> PipelineResponse:
...
def trigger_feature_engineering() -> PipelineResponse:
...
def trigger_training() -> PipelineResponse:
...
def trigger_full_pipeline(data_dir: str = "/data/matches") -> PipelineResponse:
...
def trigger_roster_sync() -> PipelineResponse:
...
def trigger_data_refresh() -> PipelineResponse:
...
def trigger_check_completed() -> CheckCompletedPydantic:
...
def trigger_thunderpick_refresh() -> PipelineResponse:
